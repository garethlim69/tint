...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
  ...
  if ($updatePasswordStmt->execute()) {
    echo "<script>alert('Password updated successfully!'); window.location.href = 'ICSettingsSecurity.php';</script>";
    exit();
  } else {
    echo "<script>alert('Error updating password. Please try again.'); window.location.href = 'ICSettingsSecurity.php';</script>";
    exit();
  }
}
?>
...
<body>
  ...
  <div class="settings-container">
    ...
    <div class="sidebar">
      <h2>Settings</h2>
      <ul>
        <li onclick="window.location.href='ICProfileSetting.php'">Profile</li>
